...
if ! [[ "$PWD" = "$GOPATH/src/github.com/weaveworks-plugins/scope-traffic-control" ]]; then
  echo "must be run from \$GOPATH/src/github.com/weaveworks-plugins/scope-traffic-control"
  exit 255
fi
